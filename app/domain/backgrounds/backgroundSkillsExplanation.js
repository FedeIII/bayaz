export const BACKGROUND_SKILLS_EXPLANATION = {
  shelterOfTheFaithful: () => (
    <>
      <p>
        Como acólito, mereces el respeto de aquellos que comparten tu fe y
        puedes realizar las ceremonias religiosas de tu deidad.
      </p>
      <p>
        Tus compañeros de aventuras y tú podéis recibir sanación gratuita y
        atención en un templo, santuario, u otra presencia establecida de tu fe,
        aunque debes proporcionar los componentes materiales necesarios para los
        conjuros. Aquellos que comparten tu religión te podrán proporcionar
        (pero sólo a ti) un estilo de vida modesto.
      </p>
      <p>
        También podrías tener vínculos con un templo específico dedicado a tu
        deidad o panteón y tener una residencia allí. Podría tratarse del templo
        que utilizas para realizar los servicios, si mantienes una buena
        relación con la comunidad, o un templo en el que has encontrado un nuevo
        hogar. Mientras estés cerca de tu templo, puedes llamar a los sacerdotes
        para que te asistan, siempre y cuando la ayuda que solicitas no ponga en
        peligro a quien la realiza y permanezcas en buena relación con tu
        templo.
      </p>
    </>
  ),
  ...
  guildMembership: () => (
    <>
      <p>
        Como un miembro de un gremio establecido y respetado, tienes ciertos
        beneficios que te provee tu membresía. Tus compañeros de gremio te
        proveerán alojamiento y comida si la necesitas y pagarán por tu funeral
        si es necesario. En algunos pueblos y ciudades, un salón del gremio
        ofrece un lugar central para encontrarse con otros miembros de tu
        profesión, que puede ser un buen lugar para conocer potenciales patro-
        nes, aliados o empleados.
      </p>
      <p>
        Los gremios a menudo poseen gran peso político. Si eres acusado de un
        crimen, tu gremio te apoyará si es factible presentar una buena defensa
        o si tu crimen es justificable. También ganas acceso a poderosas figuras
        políticas a través del gremio, si tienes una buena posición dentro de
        él. Tales conexiones podrían requerir la donación de dinero u objetos
        mágicos a las arcas del gremio.
      </p>
      <p>
        Debes pagar 5 po por mes al gremio. Si te saltas tus pagas, debes pagar
        tus deudas para permanecer en la buena gracia del gremio.
      </p>
    </>
  ),
  ...
  byPopularDemand: () => (
    <p>
      Siempre puedes encontrar un lugar para actuar, por lo general en una
      posada o ta1 berna, pero posiblemente en un circo, un teatro o incluso en
      la corte de un noble. En ese lugar, recibirás alojamiento y comida modesta
      o confortable (dependiendo de la calidad del establecimiento) gratuitos,
      siempre y cuando actúes cada noche. Además, tu actuación te convierte en
      algo así como una figura local. Cuando unos desconocidos te reconozcan en
      una ciudad en la que hayas actuado, por lo general mostrarán simpatía
      hacia tu persona.
    </p>
  ),
  ...
  falseIdentity: () => (
    <>
      ...
      <p>
        ...
        siempre y cuando hayas visto un ejemplo de la clase de documento o
        escritura que estás tratando de copiar.
      </p>
    </>
  ),
  ...
  wanderer: () => (
    <p>
      Tienes una excelente memoria para los mapas y la geografía y siempre
      puedes recordar la disposición general del terreno, los asentamientos y
      otras circunstancias de entorno que te rodea. Además, puedes encontrar
      comida y agua fresca para ti y para otras cinco personas cada día, siempre
      y cuando la tierra tenga bayas, algo de caza menor, agua y cosas por el
      estilo.
    </p>
  ),
