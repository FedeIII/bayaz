...
goog.exportSymbol('proto.gooseai.MeshRenderParameters', null, global);
...
goog.exportSymbol('proto.gooseai.PointCloudRenderParameters', null, global);
...
goog.exportSymbol('proto.gooseai.RenderParameters', null, global);
goog.exportSymbol(
  'proto.gooseai.RenderParameters.RenderParametersCase',
  null,
  global
);
...
proto.gooseai.InterpolateParameters = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.gooseai.InterpolateParameters.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.InterpolateParameters.displayName =
    'proto.gooseai.InterpolateParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.TransformColorAdjust.displayName =
    'proto.gooseai.TransformColorAdjust';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.TransformDepthCalc.displayName =
    'proto.gooseai.TransformDepthCalc';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.gooseai.TransformMatrix = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.gooseai.TransformMatrix.repeatedFields_,
    null
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.TransformResample.displayName =
    'proto.gooseai.TransformResample';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.PointCloudRenderParameters = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.PointCloudRenderParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.PointCloudRenderParameters.displayName =
 ...
 * @constructor
 */
proto.gooseai.MeshRenderParameters = function (opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.MeshRenderParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.MeshRenderParameters.displayName =
 ...
 * @constructor
 */
proto.gooseai.RenderParameters = function (opt_data) {
  jspb.Message.initialize(
    this,
    opt_data,
    0,
    -1,
    null,
    proto.gooseai.RenderParameters.oneofGroups_
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.RenderParameters.displayName = 'proto.gooseai.RenderParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.TransformCameraPose.displayName =
    'proto.gooseai.TransformCameraPose';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.gooseai.TransformParameters = function (opt_data) {
  jspb.Message.initialize(
    ...
    -1,
    null,
    proto.gooseai.TransformParameters.oneofGroups_
  );
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.gooseai.TransformParameters.displayName =
    'proto.gooseai.TransformParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.gooseai.AnswerBatch = function (opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.gooseai.AnswerBatch.repeatedFields_,
    null
  );
};
  ...
  proto.gooseai.SamplerParameters.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        stepNoiseScale: jspb.Message.getFloatingPointFieldWithDefault(
          msg,
          7,
          0.0
        ),
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.InterpolateParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.InterpolateParameters.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.gooseai.InterpolateParameters.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        ratiosList:
          (f = jspb.Message.getRepeatedFloatingPointField(msg, 1)) == null
            ? undefined
            : f,
...
proto.gooseai.InterpolateParameters.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.InterpolateParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.InterpolateParameters}
 */
proto.gooseai.InterpolateParameters.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        break;
      case 2:
        var value = /** @type {!proto.gooseai.InterpolateMode} */ (
          reader.readEnum()
        );
        msg.setMode(value);
        break;
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.InterpolateParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
  ...
  f = /** @type {!proto.gooseai.InterpolateMode} */ (
    jspb.Message.getField(message, 2)
  );
  if (f != null) {
    writer.writeEnum(2, f);
 ...
 * @return {!proto.gooseai.InterpolateParameters} returns this
 */
proto.gooseai.InterpolateParameters.prototype.addRatios = function (
  value,
  opt_index
) {
...
proto.gooseai.InterpolateParameters.prototype.getMode = function () {
  return /** @type {!proto.gooseai.InterpolateMode} */ (
    jspb.Message.getFieldWithDefault(this, 2, 0)
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformColorAdjust.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.TransformColorAdjust.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.gooseai.TransformColorAdjust.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.gooseai.TransformColorAdjust.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.TransformColorAdjust.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.TransformColorAdjust}
 */
proto.gooseai.TransformColorAdjust.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 6:
        ...
        break;
      case 7:
        var value = /** @type {!proto.gooseai.ColorMatchMode} */ (
          reader.readEnum()
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformColorAdjust.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(6, f, proto.gooseai.Artifact.serializeBinaryToWriter);
  }
  f = /** @type {!proto.gooseai.ColorMatchMode} */ (
...
proto.gooseai.TransformColorAdjust.prototype.getMatchMode = function () {
  return /** @type {!proto.gooseai.ColorMatchMode} */ (
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformDepthCalc.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.gooseai.TransformDepthCalc.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.TransformDepthCalc.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.TransformDepthCalc}
 */
proto.gooseai.TransformDepthCalc.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformDepthCalc.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformMatrix.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 * @return {!proto.gooseai.TransformMatrix}
 */
proto.gooseai.TransformMatrix.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformMatrix.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformResample.prototype.toObject = function (
    opt_includeInstance
  ) {
  ...
  proto.gooseai.TransformResample.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        transform:
          (f = msg.getTransform()) &&
          proto.gooseai.TransformMatrix.toObject(includeInstance, f),
        prevTransform:
          (f = msg.getPrevTransform()) &&
          proto.gooseai.TransformMatrix.toObject(includeInstance, f),
...
proto.gooseai.TransformResample.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.TransformResample.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.TransformResample}
 */
proto.gooseai.TransformResample.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.gooseai.BorderMode} */ (
          reader.readEnum()
        );
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformMatrix.deserializeBinaryFromReader
        );
        msg.setTransform(value);
        break;
      case 3:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformResample.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
proto.gooseai.TransformResample.prototype.getBorderMode = function () {
  return /** @type {!proto.gooseai.BorderMode} */ (
    jspb.Message.getFieldWithDefault(this, 1, 0)
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.PointCloudRenderParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.PointCloudRenderParameters.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.gooseai.PointCloudRenderParameters} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.gooseai.PointCloudRenderParameters.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
      obj = {
        ...
        pointsPerPixel: jspb.Message.getFieldWithDefault(msg, 2, 0),
      };
 ...
 */
proto.gooseai.PointCloudRenderParameters.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.PointCloudRenderParameters();
  return proto.gooseai.PointCloudRenderParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.PointCloudRenderParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.PointCloudRenderParameters}
 */
proto.gooseai.PointCloudRenderParameters.deserializeBinaryFromReader =
  function (msg, reader) {
    while (reader.nextField()) {
      if (reader.isEndGroup()) {
        break;
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.PointCloudRenderParameters.prototype.serializeBinary =
  function () {
    var writer = new jspb.BinaryWriter();
    proto.gooseai.PointCloudRenderParameters.serializeBinaryToWriter(
      this,
      writer
    );
    return writer.getResultBuffer();
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.PointCloudRenderParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.PointCloudRenderParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.gooseai.PointCloudRenderParameters.prototype.getRadius = function () {
  return /** @type {number} */ (
    jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0)
  );
};
...
/**
 * @param {number} value
 * @return {!proto.gooseai.PointCloudRenderParameters} returns this
 */
proto.gooseai.PointCloudRenderParameters.prototype.setRadius = function (
  value
) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
...
/**
 * optional uint32 points_per_pixel = 2;
 * @return {number}
 */
proto.gooseai.PointCloudRenderParameters.prototype.getPointsPerPixel =
  function () {
    return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
  };
 ...
 * @return {!proto.gooseai.PointCloudRenderParameters} returns this
 */
proto.gooseai.PointCloudRenderParameters.prototype.setPointsPerPixel =
  function (value) {
    return jspb.Message.setProto3IntField(this, 2, value);
  };
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.MeshRenderParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.MeshRenderParameters.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.gooseai.MeshRenderParameters} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.gooseai.MeshRenderParameters.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
 ...
 */
proto.gooseai.MeshRenderParameters.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.MeshRenderParameters();
  return proto.gooseai.MeshRenderParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.MeshRenderParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.MeshRenderParameters}
 */
proto.gooseai.MeshRenderParameters.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.MeshRenderParameters.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.MeshRenderParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.MeshRenderParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.MeshRenderParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.gooseai.MeshRenderParameters.prototype.getMaxMeshEdge = function () {
  return /** @type {number} */ (
    jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0)
  );
};
...
/**
 * @param {number} value
 * @return {!proto.gooseai.MeshRenderParameters} returns this
 */
proto.gooseai.MeshRenderParameters.prototype.setMaxMeshEdge = function (value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
 ...
 * @const
 */
proto.gooseai.RenderParameters.oneofGroups_ = [[1, 2]];
...
/**
 * @return {proto.gooseai.RenderParameters.RenderParametersCase}
 */
proto.gooseai.RenderParameters.prototype.getRenderParametersCase = function () {
  return /** @type {proto.gooseai.RenderParameters.RenderParametersCase} */ (
    jspb.Message.computeOneofCase(
      this,
      proto.gooseai.RenderParameters.oneofGroups_[0]
    )
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.RenderParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.RenderParameters.toObject(opt_includeInstance, this);
  };
   ...
   *     the JSPB instance for transitional soy proto support:
   *     http://goto/soy-param-migration
   * @param {!proto.gooseai.RenderParameters} msg The msg instance to transform.
   * @return {!Object}
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.gooseai.RenderParameters.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        pointcloudParameters:
          (f = msg.getPointcloudParameters()) &&
          proto.gooseai.PointCloudRenderParameters.toObject(includeInstance, f),
        meshParameters:
          (f = msg.getMeshParameters()) &&
          proto.gooseai.MeshRenderParameters.toObject(includeInstance, f),
      };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.RenderParameters}
 */
proto.gooseai.RenderParameters.deserializeBinary = function (bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.RenderParameters();
  return proto.gooseai.RenderParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.RenderParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.RenderParameters}
 */
proto.gooseai.RenderParameters.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = new proto.gooseai.PointCloudRenderParameters();
        reader.readMessage(
          value,
          proto.gooseai.PointCloudRenderParameters.deserializeBinaryFromReader
        );
        msg.setPointcloudParameters(value);
        break;
      case 2:
        var value = new proto.gooseai.MeshRenderParameters();
        reader.readMessage(
          value,
          proto.gooseai.MeshRenderParameters.deserializeBinaryFromReader
        );
        msg.setMeshParameters(value);
        break;
      default:
        reader.skipField();
        break;
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.RenderParameters.prototype.serializeBinary = function () {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.RenderParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.RenderParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.RenderParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
  f = message.getPointcloudParameters();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
  ...
  f = message.getMeshParameters();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.gooseai.MeshRenderParameters.serializeBinaryToWriter
    );
  }
};

/**
 * optional PointCloudRenderParameters pointcloud_parameters = 1;
 * @return {?proto.gooseai.PointCloudRenderParameters}
 */
proto.gooseai.RenderParameters.prototype.getPointcloudParameters = function () {
  return /** @type{?proto.gooseai.PointCloudRenderParameters} */ (
...
/**
 * @param {?proto.gooseai.PointCloudRenderParameters|undefined} value
 * @return {!proto.gooseai.RenderParameters} returns this
 */
proto.gooseai.RenderParameters.prototype.setPointcloudParameters = function (
  value
) {
  return jspb.Message.setOneofWrapperField(
    this,
 ...
 * @return {!proto.gooseai.RenderParameters} returns this
 */
proto.gooseai.RenderParameters.prototype.clearPointcloudParameters =
  function () {
    return this.setPointcloudParameters(undefined);
  };
 ...
 * @return {boolean}
 */
proto.gooseai.RenderParameters.prototype.hasPointcloudParameters = function () {
  return jspb.Message.getField(this, 1) != null;
};

/**
 * optional MeshRenderParameters mesh_parameters = 2;
 * @return {?proto.gooseai.MeshRenderParameters}
 */
proto.gooseai.RenderParameters.prototype.getMeshParameters = function () {
  return /** @type{?proto.gooseai.MeshRenderParameters} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.MeshRenderParameters, 2)
  );
};

/**
 * @param {?proto.gooseai.MeshRenderParameters|undefined} value
 * @return {!proto.gooseai.RenderParameters} returns this
 */
proto.gooseai.RenderParameters.prototype.setMeshParameters = function (value) {
  return jspb.Message.setOneofWrapperField(
    this,
    2,
    proto.gooseai.RenderParameters.oneofGroups_[0],
 ...
 * @return {!proto.gooseai.RenderParameters} returns this
 */
proto.gooseai.RenderParameters.prototype.clearMeshParameters = function () {
  return this.setMeshParameters(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.RenderParameters.prototype.hasMeshParameters = function () {
  return jspb.Message.getField(this, 2) != null;
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.CameraParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
...
proto.gooseai.CameraParameters.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.CameraParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.CameraParameters}
 */
proto.gooseai.CameraParameters.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = /** @type {!proto.gooseai.CameraType} */ (
          reader.readEnum()
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.CameraParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
proto.gooseai.CameraParameters.prototype.getCameraType = function () {
  return /** @type {!proto.gooseai.CameraType} */ (
    jspb.Message.getFieldWithDefault(this, 1, 0)
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformCameraPose.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.TransformCameraPose.toObject(
      opt_includeInstance,
      this
    );
  };
  ...
  proto.gooseai.TransformCameraPose.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        worldToViewMatrix:
          (f = msg.getWorldToViewMatrix()) &&
          proto.gooseai.TransformMatrix.toObject(includeInstance, f),
        cameraParameters:
          (f = msg.getCameraParameters()) &&
          proto.gooseai.CameraParameters.toObject(includeInstance, f),
        imageRenderParameters:
          (f = msg.getImageRenderParameters()) &&
          proto.gooseai.RenderParameters.toObject(includeInstance, f),
        maskRenderParameters:
          (f = msg.getMaskRenderParameters()) &&
          proto.gooseai.RenderParameters.toObject(includeInstance, f),
...
proto.gooseai.TransformCameraPose.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.TransformCameraPose.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.TransformCameraPose}
 */
proto.gooseai.TransformCameraPose.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.gooseai.CameraParameters.deserializeBinaryFromReader
        );
        msg.setCameraParameters(value);
        break;
      case 3:
        var value = new proto.gooseai.RenderParameters();
        reader.readMessage(
          value,
          proto.gooseai.RenderParameters.deserializeBinaryFromReader
        );
        msg.setImageRenderParameters(value);
        break;
      case 4:
        var value = new proto.gooseai.RenderParameters();
        reader.readMessage(
        ...
        msg.setMaskRenderParameters(value);
        break;
      case 5:
        var value = /** @type {boolean} */ (reader.readBool());
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformCameraPose.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
  ...
  f = message.getImageRenderParameters();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.gooseai.RenderParameters.serializeBinaryToWriter
    );
  }
  f = message.getMaskRenderParameters();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
 ...
 */
proto.gooseai.TransformCameraPose.prototype.setWorldToViewMatrix = function (
  value
) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearWorldToViewMatrix =
  function () {
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.setCameraParameters = function (
  value
) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearCameraParameters =
  function () {
...
/**
 * optional RenderParameters image_render_parameters = 3;
 * @return {?proto.gooseai.RenderParameters}
 */
proto.gooseai.TransformCameraPose.prototype.getImageRenderParameters =
  function () {
    return /** @type{?proto.gooseai.RenderParameters} */ (
      jspb.Message.getWrapperField(this, proto.gooseai.RenderParameters, 3)
    );
  };

/**
 * @param {?proto.gooseai.RenderParameters|undefined} value
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.setImageRenderParameters =
  function (value) {
    return jspb.Message.setWrapperField(this, 3, value);
  };
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearImageRenderParameters =
  function () {
    return this.setImageRenderParameters(undefined);
  };
 ...
 * @return {boolean}
 */
proto.gooseai.TransformCameraPose.prototype.hasImageRenderParameters =
  function () {
    return jspb.Message.getField(this, 3) != null;
  };

/**
 * optional RenderParameters mask_render_parameters = 4;
 * @return {?proto.gooseai.RenderParameters}
 */
proto.gooseai.TransformCameraPose.prototype.getMaskRenderParameters =
  function () {
    return /** @type{?proto.gooseai.RenderParameters} */ (
      jspb.Message.getWrapperField(this, proto.gooseai.RenderParameters, 4)
    );
  };
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.setMaskRenderParameters = function (
  value
) {
  return jspb.Message.setWrapperField(this, 4, value);
};
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearMaskRenderParameters =
  function () {
    return this.setMaskRenderParameters(undefined);
  };
 ...
 * @return {boolean}
 */
proto.gooseai.TransformCameraPose.prototype.hasMaskRenderParameters =
  function () {
    return jspb.Message.getField(this, 4) != null;
  };
...
proto.gooseai.TransformParameters.prototype.getTransformCase = function () {
  return /** @type {proto.gooseai.TransformParameters.TransformCase} */ (
    jspb.Message.computeOneofCase(
      this,
      proto.gooseai.TransformParameters.oneofGroups_[0]
    )
  );
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.TransformParameters.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.gooseai.TransformParameters.toObject(
      opt_includeInstance,
      this
    );
  };
  ...
  proto.gooseai.TransformParameters.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        colorAdjust:
          (f = msg.getColorAdjust()) &&
          proto.gooseai.TransformColorAdjust.toObject(includeInstance, f),
        depthCalc:
          (f = msg.getDepthCalc()) &&
          proto.gooseai.TransformDepthCalc.toObject(includeInstance, f),
        resample:
          (f = msg.getResample()) &&
          proto.gooseai.TransformResample.toObject(includeInstance, f),
        cameraPose:
          (f = msg.getCameraPose()) &&
          proto.gooseai.TransformCameraPose.toObject(includeInstance, f),
      };
...
proto.gooseai.TransformParameters.deserializeBinary = function (bytes) {
  ...
  return proto.gooseai.TransformParameters.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.gooseai.TransformParameters}
 */
proto.gooseai.TransformParameters.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 2:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformColorAdjust.deserializeBinaryFromReader
        );
      ...
      case 4:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformDepthCalc.deserializeBinaryFromReader
        );
      ...
      case 5:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformResample.deserializeBinaryFromReader
        );
      ...
      case 6:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformCameraPose.deserializeBinaryFromReader
        );
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.TransformParameters.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.gooseai.AnswerBatch.prototype.toObject = function (
    opt_includeInstance
  ) {
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(
          value,
          proto.gooseai.Answer.deserializeBinaryFromReader
        );
 ...
 * @return {!proto.gooseai.Answer}
 */
proto.gooseai.AnswerBatch.prototype.addAnswers = function (
  opt_value,
  opt_index
) {
  return jspb.Message.addToRepeatedWrapperField(
  ...
  proto.gooseai.Request.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        interpolate:
          (f = msg.getInterpolate()) &&
          proto.gooseai.InterpolateParameters.toObject(includeInstance, f),
        transform:
          (f = msg.getTransform()) &&
          proto.gooseai.TransformParameters.toObject(includeInstance, f),
        conditioner:
          (f = msg.getConditioner()) &&
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 11:
        ...
        reader.readMessage(
          value,
          proto.gooseai.InterpolateParameters.deserializeBinaryFromReader
        );
      ...
      case 12:
        ...
        reader.readMessage(
          value,
          proto.gooseai.TransformParameters.deserializeBinaryFromReader
        );
        msg.setTransform(value);
        break;
      case 6:
